...
var ___CSS_LOADER_URL_IMPORT_9___ = new URL(/* asset import */ __webpack_require__(661), __webpack_require__.b);
...
var ___CSS_LOADER_URL_IMPORT_13___ = new URL(/* asset import */ __webpack_require__(311), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_14___ = new URL(/* asset import */ __webpack_require__(451), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_15___ = new URL(/* asset import */ __webpack_require__(914), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_16___ = new URL(/* asset import */ __webpack_require__(967), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_17___ = new URL(/* asset import */ __webpack_require__(644), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_18___ = new URL(/* asset import */ __webpack_require__(368), __webpack_require__.b);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.tourist-places{list-style:none;padding:0;margin:0;box-shadow:0 .125rem .25rem rgba(0,0,0,.075);border-radius:.5rem;background-color:#fff}.tourist-places li{position:relative;display:block;padding:.75rem 1.25rem;margin:0;background-color:#fff;border:1px solid #dee2e6;border-bottom:none}.tourist-places li:last-child{border-bottom:1px solid #dee2e6}.booking-section{background-color:#fff;border-radius:.5rem;box-shadow:0 .125rem .25rem rgba(0,0,0,.075)}.booking-section .booking-form{display:flex;flex-direction:column;border-radius:20px}.booking-section .booking-form input,.booking-section .booking-form select,.booking-section .booking-form textarea{margin-bottom:1rem;padding:.5rem;border-radius:20px;border:1px solid #ced4da;font-size:1rem;color:#000}.booking-section .booking-form input:focus,.booking-section .booking-form select:focus,.booking-section .booking-form textarea:focus{border-color:#000;box-shadow:0 0 .25rem rgba(0,123,255,.25)}body.create_account .card-form{width:100%;max-width:500px;background-color:#f8f9fa}body.index{color:#000;font-family:"Cairo",sans-serif;line-height:1.8}body.index .list-index{color:#000}body.index .list-index ul li{margin-top:10px;margin-bottom:10px}body.index .contact-us{color:#000;margin-top:10px;margin-bottom:10px;color:#000}body.index .contact-us a{color:#000;text-decoration:none;font-size:20px;font-weight:600}body.index .contact-us a:hover{color:#00b7ff;text-decoration:underline}body.index .contact-us i{margin-right:30px;margin-left:10px;transform:scale(1.2)}body.index #Carousel{color:#000}body.index #Carousel i{background-color:#e5ff00;color:#000;padding:10px 13px;margin:10px;font-size:20px;box-shadow:0 0 10px rgba(0,0,0,.5);transition:all .3s ease;border-radius:50%}body.index #Carousel i:hover{background-color:#e5ff00;color:#000;box-shadow:0 0 20px rgba(0,0,0,.5)}body.index #Carousel img{border-radius:20px;box-shadow:0 5px 15px rgba(0,0,0,.2)}body.index .tour-card{border-radius:10px;overflow:hidden;box-shadow:0 4px 12px rgba(0,0,0,.1);transition:transform .3s ease,box-shadow .3s ease}body.index .tour-card:hover{transform:scale(1.03);box-shadow:0 6px 18px rgba(0,0,0,.15)}body.index .tour-card .card-img-top{height:200px;object-fit:cover}body.index .tour-card .card-body{padding:1.5rem}body.index .tour-card .card-body .card-title{font-size:1.3rem;margin-bottom:.75rem}body.index .tour-card .card-body .card-text{font-size:1rem;color:#555}body.index .tour-card .card-body .btn{margin-top:1rem}body.index .Traveller-img{position:relative}body.index .Traveller-img img{position:absolute;top:80px;right:20px;transform:scale(1.3);width:100%}@media(min-width: 250px)and (max-width: 767px){body.index{font-size:80%}body.index .Traveller-img{display:flex;justify-content:center;align-items:center;margin-bottom:2rem}body.index .Traveller-img img{position:static;transform:none;width:100%;max-width:350px;height:auto;display:block;margin:0 auto}}@media(min-width: 768px)and (max-width: 991px){body.index{font-size:90%}body.index .Traveller-img{display:flex;justify-content:center;align-items:center;margin-bottom:2rem}body.index .Traveller-img img{position:static;transform:none;width:200%;max-width:650px;height:auto;display:block;margin:0 auto}}@media(min-width: 992px){body.index .traveler-image{transform:scale(0.75);transform-origin:right center}}@media(min-width: 1200px)and (max-width: 2500px){body.index .Traveller-img img{position:static;transform:none;width:200%;max-width:650px;height:auto;margin:0 auto}}body.Login .card-form{width:100%;max-width:500px;background-color:#f8f9fa}body.round{background-color:#888;color:#3e2723}body.round .intro-section{color:#3e2723}body.round .gallery-section{background-color:#888}body.round .gallery-section img{transition:transform .3s ease}body.round .gallery-section img:hover{transform:scale(1.05)}body.round .booking-section{color:#3e2723}body.round .booking-section .booking-form input,body.round .booking-section .booking-form select,body.round .booking-section .booking-form textarea{color:#3e2723;border:1px solid #3e2723}body.round .slide{color:#b48a5a}body.round .slide i{background-color:#e5ff00;color:#b48a5a;padding:10px 13px;margin:10px;font-size:20px;box-shadow:0 0 10px rgba(0,0,0,.5);transition:all .3s ease;border-radius:50%}body.round .slide i:hover{background-color:#e5ff00;color:#b48a5a;box-shadow:0 0 20px rgba(0,0,0,.5)}body.round .slide img{border-radius:20px;box-shadow:0 5px 15px rgba(0,0,0,.2)}body.round ul li{color:#3e2723}body.round2{margin:0;padding:0;background-color:#f0f6ff;color:#183153}body.round2 .intro-section{color:#183153}body.round2 .gallery-section{background-color:#f0f6ff}body.round2 .gallery-section img{transition:transform .3s ease}body.round2 .gallery-section img:hover{transform:scale(1.05)}body.round2 .booking-section{color:#183153}body.round2 .booking-section .booking-form input,body.round2 .booking-section .booking-form select,body.round2 .booking-section .booking-form textarea{color:#183153;border:1px solid #183153}body.round2 .slide{color:#198754}body.round2 .slide i{background-color:#e5ff00;color:#198754;padding:10px 13px;margin:10px;font-size:20px;box-shadow:0 0 10px rgba(0,0,0,.5);transition:all .3s ease;border-radius:50%}body.round2 .slide i:hover{background-color:#e5ff00;color:#198754;box-shadow:0 0 20px rgba(0,0,0,.5)}body.round2 .slide img{border-radius:20px;box-shadow:0 5px 15px rgba(0,0,0,.2)}body.round2 ul li{color:#183153}@media(max-width: 768px){body.round2{font-size:70%;margin-top:10px}body.round2 .tourCarousel{height:100%;max-height:400px;overflow:hidden;width:fit-content;margin:0 auto;transform:scale(0.9)}body.round2 footer{position:relative;bottom:0;width:100%;padding:10px;text-align:center}}body{background-color:#fff}body nav{background:rgba(0,0,0,0)}body nav li{font-family:"Tajawal",sans-serif;font-weight:200;font-style:normal}body nav img{width:70%;height:auto}body .btn{margin:10px}body footer .list-unstyled li{color:#7e7e7e !important;font-size:16px;text-align:start}body footer i{color:#7e7e7e !important}body footer .footer-custom a:hover{color:#ffc107 !important}body footer .footer-map iframe{border-radius:8px}`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var bootstrap_min = __webpack_require__(261);
...
var update = injectStylesIntoStyleTag_default()(bootstrap_min/* default */.A, options);
...
var scss_main = __webpack_require__(386);
;// ./src/scss/main.scss
...
var main_update = injectStylesIntoStyleTag_default()(scss_main/* default */.A, main_options);




       /* harmony default export */ const src_scss_main = (scss_main/* default */.A && scss_main/* default */.A.locals ? scss_main/* default */.A.locals : undefined);
